  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <motion.nav
        ...
        className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md shadow-sm z-50 border-b border-purple-600/10"
      >
          ...
          <div className="flex justify-between h-16">
            ...
            {showAuthenticatedUI ? (
              <div className="hidden sm:flex sm:items-center sm:space-x-4">
                <Link
                  to="/app"
                  className={`inline-flex items-center px-3 py-2 text-sm font-medium transition-colors ${location.pathname === '/app'
                    ? 'text-purple-600 border-b-2 border-purple-600'
                    : 'text-gray-900/70 hover:text-purple-600 hover:border-b-2 hover:border-indigo-600/50'
                    }`}
                  ref={(el) => {
                    if (el) {
                      prefetchOnHover(el, './pages/Home');
                      prefetchOnFocus(el, './pages/Home');
                    }
                  }}
                >
                ...
                <Link
                  to="/app/contacts"
                  className={`inline-flex items-center px-3 py-2 text-sm font-medium transition-colors ${location.pathname === '/app/contacts'
                    ? 'text-purple-600 border-b-2 border-purple-600'
                    : 'text-gray-900/70 hover:text-purple-600 hover:border-b-2 hover:border-indigo-600/50'
                    }`}
                  ref={(el) => {
                    if (el) {
                      prefetchOnHover(el, './pages/Contacts');
                      prefetchOnFocus(el, './pages/Contacts');
                    }
                  }}
                >
                ...
                <Link
                  to="/app/profile"
                  className={`inline-flex items-center px-3 py-2 text-sm font-medium transition-colors ${location.pathname === '/app/profile'
                    ? 'text-purple-600 border-b-2 border-purple-600'
                    : 'text-gray-900/70 hover:text-purple-600 hover:border-b-2 hover:border-indigo-600/50'
                    }`}
                >
                ...
                <Link
                  to="/app/settings"
                  className={`inline-flex items-center px-3 py-2 text-sm font-medium transition-colors ${location.pathname === '/app/settings'
                    ? 'text-purple-600 border-b-2 border-purple-600'
                    : 'text-gray-900/70 hover:text-purple-600 hover:border-b-2 hover:border-indigo-600/50'
                    }`}
                >
                ...
                <div className="relative ml-2">
                  <button
                    ...
                    className="p-2 text-gray-900/70 hover:text-purple-600 hover:bg-purple-600/10 rounded-full relative transition-colors hover:shadow-lg hover:shadow-purple-500/25"
                    title="Show QR Code"
                  >
                ...
                <div className="relative">
                  <button
                    ...
                    className="p-2 text-gray-900/70 hover:text-purple-600 relative transition-colors"
                  >
                    <Bell className="h-5 w-5" />
                    {unreadNotifications > 0 && (
                      <span className="absolute top-0 right-0 block h-2 w-2 rounded-full bg-pink-600 ring-2 ring-white" />
                    )}
                  </button>
              ...
              <div className="flex items-center">
                <Link
                  to="/app/login"
                  className="text-gray-900/70 hover:text-purple-600 px-3 py-2 rounded-md text-sm font-medium transition-colors"
                >
                  Login
                </Link>
                <Link
                  to="/app/register"
                  className="ml-4 px-4 py-2 rounded-md text-sm font-medium text-white from-purple-500 to-indigo-600 hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-200"
                >
                  Register
                </Link>
              </div>
            ...
            {showAuthenticatedUI && (
              <div className="sm:hidden flex items-center">
                <button
                  ...
                  className="inline-flex items-center justify-center p-2 rounded-md text-accessible-muted hover:text-gray-500 hover:bg-gray-100"
                >
      ...
      <AnimatePresence>
        {showMobileNav && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -50 }}
            className="sm:hidden fixed inset-x-0 top-16 bg-white/95 backdrop-blur-md shadow-lg z-40 border-b border-purple-600/10"
          >
            <div className="px-2 pt-2 pb-3 space-y-1">
              <Link
                to="/app"
                className={`block px-3 py-2 rounded-md text-base font-medium ${location.pathname === '/app'
                  ? 'text-purple-600 bg-purple-600/10'
                  : 'text-gray-900/70 hover:text-purple-600 hover:bg-purple-600/10'
                  }`}
              ...
              <Link
                to="/app/contacts"
                className={`block px-3 py-2 rounded-md text-base font-medium ${location.pathname === '/app/contacts'
                  ? 'text-purple-600 bg-purple-600/10'
                  : 'text-gray-900/70 hover:text-purple-600 hover:bg-purple-600/10'
                  }`}
                onClick={() => setShowMobileNav(false)}
              ...
              <Link
                to="/app/profile"
                className={`block px-3 py-2 rounded-md text-base font-medium ${location.pathname === '/app/profile'
                  ? 'text-purple-600 bg-purple-600/10'
                  : 'text-gray-900/70 hover:text-purple-600 hover:bg-purple-600/10'
                  }`}
                onClick={() => setShowMobileNav(false)}
              ...
              <Link
                to="/app/settings"
                className={`block px-3 py-2 rounded-md text-base font-medium ${location.pathname === '/app/settings'
                  ? 'text-purple-600 bg-purple-600/10'
                  : 'text-gray-900/70 hover:text-purple-600 hover:bg-purple-600/10'
                  }`}
                onClick={() => setShowMobileNav(false)}
              ...
              <div className="border-t border-gray-200 pt-2 mt-2">
                <button
                  ...
                  className="w-full text-left px-3 py-2 rounded-md text-base font-medium text-gray-900/70 hover:text-purple-600 hover:bg-purple-600/10"
                >
                  <QrCode className="h-5 w-5 inline-block mr-2 text-purple-600" />
                  Show QR Code
                </button>
              </div>
        ...
        >
          <div className="grid grid-cols-4 h-16">
            ...
            >
              ...
              <span className="text-xs mt-1 text-gray-900/70 group-hover:text-purple-600 transition-colors duration-300">Connect</span>
            </button>
