...
interface InvitationFormEnhancedProps {
...
export function InvitationFormEnhanced({ 
  connectionCode, 
  userData, 
  onSuccess, 
  onError 
}: InvitationFormEnhancedProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Submit invitation request using enhanced function
