...
export function Home() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pb-[env(safe-area-inset-bottom)]">
      ...
      <div className="mb-6">
        <div
          className="flex items-center justify-between cursor-pointer bg-white p-3 rounded-xl shadow-sm border border-purple-500/10 hover:shadow-lg transition-all duration-300"
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Your Network Insights</h2>
      ...
      {requests.length > 0 && (
        <div id="connection-requests" className="mb-8">
          <div className="flex justify-between items-center mb-4 bg-gradient-to-r from-indigo-500/10 to-indigo-500/20 p-3 rounded-lg border border-indigo-600/30">
            <motion.div
            ...
            >
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 flex items-center">
                  Connection Requests
                  <span className="ml-2 bg-indigo-600/20 text-gray-900 text-xs font-medium px-2.5 py-0.5 rounded-full">
                    {requests.length}
                  </span>
                </h2>
                <p className="text-xs text-gray-900/70">People waiting to connect with you</p>
              </div>
            </motion.div>
          </div>
          {loading ? (
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4 bg-gradient-to-r from-indigo-50 to-indigo-100 p-3 rounded-lg border border-indigo-200">
          <motion.div
            ...
            className="flex items-center"
          >
            <div className="p-2 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full mr-3 shadow-sm">
            ...
            {searchQuery ? (
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => navigate('/app/contacts')}
                  className="btn-captamundi-primary inline-flex items-center px-4 py-2 rounded-lg text-sm"
                >
