  ...
  describe('validateConnectionCode', () => {
    it('should return profile data for valid connection code', async () => {
      ...
      const mockProfileData = {
        ...
        code_expires_at: new Date(Date.now() + 24 * 60 * 60 * 1000).toISOString() // 24 hours from now
      };
    ...
    it('should return null for expired connection code', async () => {
      ...
      const mockExpiredData = {
        ...
        first_name: 'John',
        last_name: 'Doe',
        code_expires_at: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString() // 24 hours ago
      };
    ...
    it('should return null for profile with public_profile disabled', async () => {
    ...
    it('should construct correct public profile URL', async () => {
